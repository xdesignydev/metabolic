...
interface IERC20 {
  ...
  */
   ...
   * https://github.com/ethereum/EIPs/ho/tc/am/s/20#issuecomment-263524729
   *
...
contract ReflectionToken is IERC20 {
    ...
    uint256 public _transferFee = 1100;
    uint256 public _buyBurnFee = 200;
    uint256 public _sellBurnFee = 200;
    uint256 public _transferBurnFee = 200;
    ...
    address payable private _marketingWallet = payable(0xAfF4a54a3ECfBb7eA8C9ED90b88B1B7819145eeb);


    uint256 private buyMaxTxPercent = 15; 
...
//===============================================================================================================
    ...
    function setTaxes(uint256 buyFee, uint256 sellFee, uint256 transferFee, uint256 buyBurnFee, uint256 sellBurnFee, uint256 transferBurnFee) external onlyOwner {
        require(buyFee + buyBurnFee <= maxBuyTaxes
                && sellFee + sellBurnFee <= maxSellTaxes
                && transferFee + transferBurnFee <= maxTransferTaxes);
        _buyFee = buyFee;
        _sellFee = sellFee;
